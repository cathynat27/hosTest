...
// import { getCampaigns } from "@/lib/api"; // ← uncomment when backend is ready
...
// Using same function name as the real API so no call sites below need changing.
...
const MOCK_CAMPAIGNS: Campaign[] = [
  {
    ...
    created_by: "admin-1",
    recipient_count_targeted: 89,
    recipient_count_sent: 87,
  ...
  },
  {
    id: "camp-002",
    hotel_id: "hotel-1",
    name: "Pre-Arrival Upsell — June Check-ins",
    campaign_type: "pre_arrival_upsell",
    template_id: "tmpl-002",
    variable_overrides: {},
    audience_filters: { check_in_from: "2026-06-01", check_in_to: "2026-06-15" },
    status: "scheduled",
    scheduled_at: "2026-05-28T09:00:00Z",
    sent_at: null,
    completed_at: null,
    created_by: "admin-1",
    recipient_count_targeted: 45,
  ...
  },
  {
    id: "camp-004",
    hotel_id: "hotel-1",
    name: "Late Checkout Push — Long-stay Guests",
    campaign_type: "late_checkout",
    template_id: "tmpl-003",
    variable_overrides: {},
    audience_filters: { min_stay_nights: 3 },
    status: "processing",
    scheduled_at: null,
    sent_at: "2026-05-06T08:00:00Z",
    completed_at: null,
    created_by: "admin-1",
    recipient_count_targeted: 22,
    recipient_count_sent: 14,
    recipient_count_skipped: 1,
    created_at: "2026-05-05T19:00:00Z",
  },
  {
    id: "camp-005",
    hotel_id: "hotel-1",
    name: "Post-Stay Win-Back — April Guests",
    campaign_type: "post_stay_reengagement",
    template_id: "tmpl-004",
    variable_overrides: {},
    audience_filters: { check_out_from: "2026-04-01", check_out_to: "2026-04-30" },
    status: "failed",
    scheduled_at: null,
    sent_at: "2026-05-01T07:00:00Z",
    completed_at: null,
    created_by: "admin-1",
    recipient_count_targeted: 60,
    recipient_count_sent: 0,
    recipient_count_skipped: 0,
...
async function getCampaigns(): Promise<Campaign[]> {
  await new Promise((r) => setTimeout(r, 700)); // simulates network latency
